#!/usr/bin/env bash
# ============================================================================
# silver-stack — Jenkins Server Installer
...
bash <(curl -fsSL "https://raw.githubusercontent.com/ibtisam-iq/silver-stack/main/scripts/system-checks/preflight.sh") >/dev/null 2>&1 && ok "Preflight passed." || error "Preflight failed — aborting."
blank
