#!/usr/bin/env bash
# ===============================================================
# silver-stack : Shared Core Library (common.sh)
#
# Provides:
#   • Strict shell safety
#   • Colorized logging
...
if [[ ! -t 0 ]]; then
  PIPE_MODE=1
  TMP_BASE="$(mktemp -d -t silver-stack-XXXXXXXX)"
...
source_remote_library() {
  ...
  local tmp_file
  tmp_file="$(mktemp -t silver-stack-XXXXXXXX.sh)"
...
export K8S_BASE_URL="https://raw.githubusercontent.com/ibtisam-iq/silver-stack/main/scripts/kubernetes"
export PREFLIGHT_URL="https://raw.githubusercontent.com/ibtisam-iq/silver-stack/main/scripts/system-checks/preflight.sh"
