...
# silver-stack — Kubernetes CLI Toolchain Installer
# ----------------------------------------------------
...
# --------------------------- Header ---------------------------
echo -e "\n╔════════════════════════════════════════════════════════╗"
echo -e   "║ silver-stack — Kubernetes CLI Toolchain            ║"
echo -e   "╚════════════════════════════════════════════════════════╝"

# --------------------------- Preflight ---------------------------
section "Running preflight checks..."
if bash <(curl -fsSL "https://raw.githubusercontent.com/ibtisam-iq/silver-stack/main/scripts/system-checks/preflight.sh") >/dev/null 2>&1; then
  ok "Preflight passed."
else
